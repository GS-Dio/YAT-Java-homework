...
//        if (indexMember >= 0 && indexMember < members.length && members[indexMember].getIsActive()) {
//            members[indexMember].deActivate(); // Устанавливаем флаг isActive в false для члена библиотеки по указанному индексу
//            System.out.println("Член библиотеки успешно деактивирован.");
//        } else {
//            System.out.println("Деактивация не удалась: неверный индекс или член библиотеки уже неактивен.");
//        }
//    }
//
//    public void activateMember(int indexMember) {
//        if (indexMember >= 0 && indexMember < members.length && !members[indexMember].getIsActive()) {
//            members[indexMember].activate(); // Устанавливаем флаг isActive в true для члена библиотеки по указанному индексу
//            System.out.println("Член библиотеки успешно активирован.");
//        } else {
//            System.out.println("Активация не удалась: неверный индекс или член библиотеки уже активен.");
//        }
//    }
    public void deActivateMember(int indexMember) {
        for (int i = 0; i < members.length; i++) {
